...
CREATE TABLE `employee_order` (
  ...
  `order_1` varchar(255) NOT NULL,
  `order_2` varchar(255) NOT NULL,
...
INSERT INTO `employee_order` VALUES (89,'Samosa','Meetha Samosa',50),(90,'JMB Ke special Samose','Tandoori Samosa',80);
